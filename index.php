					...
					<div class="aside-nav d-flex flex-column align-items-center flex-column-fluid pb-10 scroll ps" style="overflow: hidden;">
						...
						<ul class="nav flex-column">
							...
							<li class="nav-item mb-2" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="" data-original-title="Главная">
								<a href="index.html" class="nav-link btn btn-icon btn-lg btn-borderless active">
												...
												<div class="card-body p-0" style="position: relative;">
													<div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
														...
														<div class="d-flex flex-column text-right">
															<span class="text-dark-75 font-weight-bolder font-size-h3">{{userScheta[0][3]}}П.</span>
															<span class="text-muted font-weight-bold mt-2">{{ userScheta[0][2] }}</span>
														</div>
													</div>
													
												<div class="resize-triggers"><div class="expand-trigger"><div style="width: 517px; height: 258px;"></div></div><div class="contract-trigger"></div></div></div>
												<!--end::Body-->
												{% endif%}
											</div>
											<div class="card card-custom gutter-b">
												...
												<div class="card-body p-0" style="position: relative;">
													<div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
														...
														<div class="d-flex flex-column text-right">
															<span class="text-dark-75 font-weight-bolder font-size-h3">{{userScheta[1][3]}}П.</span>
															<span class="text-muted font-weight-bold mt-2">{{ userScheta[1][2] }}</span>
														</div>
													</div>
											...
											<div class="card card-custom">
												...
												<div class="card-body p-0" style="position: relative;">
													<div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
														...
														<div class="d-flex flex-column text-right">
															<a href="createme.html" class="btn btn-light-primary font-weight-bold mr-2">Создать счет</a>
														</div>
													</div>
												<div class="resize-triggers"><div class="expand-trigger"><div style="width: 517px; height: 258px;"></div></div><div class="contract-trigger"></div></div></div>
												<!--end::Body-->
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">Последние переводы</span>
												</h3>
											</div>
											<!--end::Header-->
											<!--begin::Body-->
																...
																<tbody>
																		<td class="py-5 pl-0">
																			<div class="symbol symbol-50 symbol-light mr-2">
																				<span class="symbol-label">
																					<img src="./assets_new/transfer.png" class="h-50 align-self-center" alt="">
																				</span>
																			</div>
																		</td>
																		<td class="pl-0">
																			<a href="https://preview.keenthemes.com/metronic/demo10/index.html#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">{{i[6]}} П.</a>
																			<span class="text-muted font-weight-bold d-block">{{ i[5] }}</span>
																		</td>
																		<td class="text-right">
																			<span class="text-muted font-weight-500">Перевод</span>
																		</td>
																		<td class="text-right">
																			<span class="label label-lg label-light-success label-inline">Успешно</span>
																		</td>
																	</tr>
																</tbody>
																{% endfor %}
                                    						    {% else %}
                                    						    <h3 class="text-black-50 small m-0">Вы не сделали не 1 перевода. Когда вы переведёте любому игроку деньги, они отобразятся тут.</h3>
                                    						    {% endif %}
															</table>
														</div>
														<!--end::Table-->
									...
									<div class="col-xl-5">
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0">
												<h3 class="card-title font-weight-bolder text-dark">Неопл. счета</h3>
												<div class="card-toolbar">
													<div class="dropdown dropdown-inline">
														<a class="btn btn-light btn-sm font-size-sm font-weight-bolder dropdown-toggle text-dark-75" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Оплатить выделеные</a>
													</div>
												</div>
											</div>
											<!--end::Header-->
											...
											<div class="card-body pt-2">
												...
												<div class="d-flex align-items-center">
													...
													<div class="d-flex flex-column flex-grow-1">
														<a href="https://preview.keenthemes.com/metronic/demo10/index.html#" class="text-dark-75 text-hover-primary font-weight-bold font-size-lg mb-1">Create FireStone Logo</a>
														<span class="text-muted font-weight-bold">Due in 2 Days</span>
													</div>
													<!--end::Text-->
													<!--begin::Dropdown-->
													<div class="dropdown dropdown-inline ml-2" data-toggle="tooltip" title="" data-placement="left" data-original-title="Оплатить">
														<a href="https://preview.keenthemes.com/metronic/demo10/index.html#" class="btn btn-hover-light-primary btn-sm btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
